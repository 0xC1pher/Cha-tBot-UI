...
export const cleanSelectedConversation = (conversation: Conversation) => {
  // added model for each conversation (3/20/24)
  // added system prompt for each conversation (3/21/24)
  // added folders (3/23/24)
  // added prompts (3/26/24)
  // added messages (4/16/24)
